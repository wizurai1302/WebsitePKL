...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card mt-5">
                    <div class="card-header" style="text-align: center;">{{ __('Input Data Perusahaan') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('perusahaan')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="form-group row mt-4">
                              ...
                              <div class="form-group row mt-4">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="keunggulan" id="keunggulan"  rows="3">
                                    </textarea>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="category_id" id="category_id" placeholder="">
                                </div>
                              </div>
                              <div class="form-group row mt-4">
